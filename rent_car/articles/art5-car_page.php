            ...
            <div class="car-page-container">
                ...
                <div class="car-images">
                    <div class="choosen-car-image">
                        <img class="chosen-image" src="resources/fiat1.jpg" alt="">
                    </div>
                    <div class="gallery-car-images">
                        <div class="wrap-inactive-img">
                            <img class="inactive-image" src="resources/fiat2.jpg" alt="">
                        </div>
                        <div class="wrap-inactive-img">
                            <img class="inactive-image" src="resources/fiat3.jpg" alt="">
                        </div>
                        <div class="wrap-inactive-img">
                            <img class="inactive-image" src="resources/fiat4.jpg" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="car-description">
                    ...
                    <div class="text-description">
                        <p>Наша компания предлагает общедоступную аренду 
                            ...
                            Fiat Egea, который обеспечит все ваши 
                            потребности в передвижении. Просторный 
