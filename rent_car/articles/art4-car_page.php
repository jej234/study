            ...
            <div class="car-page-container">
                ...
                <div class="car-images">
                    <div class="choosen-car-image">
                        <img class="chosen-image" src="resources/corolla.jpg" alt="">
                    </div>
                    <div class="gallery-car-images">
                        <div class="wrap-inactive-img">
                            <img class="inactive-image" src="resources/corolla1.jpg" alt="">
                        </div>
                        <div class="wrap-inactive-img">
                            <img class="inactive-image" src="resources/corolla2.jpg" alt="">
                        </div>
                        <div class="wrap-inactive-img">
                            <img class="inactive-image" src="resources/corolla3.jpg" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="car-description">
                    ...
                    <div class="text-description">
                        <p>Наша компания предлагает общедоступную аренду 
                            ...
                            Toyoya Corolla, который обеспечит все ваши 
